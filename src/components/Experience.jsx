...
const Experience = () => {
  ...
  return (
    <div name="skills" className='bg-gradient-to-b from-black to-gray-800 text-white
     w-full h-full'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-gray-400 text-green-400'>Skills</p>
